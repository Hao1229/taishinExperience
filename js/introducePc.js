...
$('.introduce__map-land__left-section__three__click-section, .introduce__map-land__left-section__three__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
    $('.introduce__map-land__left-section__four').addClass('introduce__map-land__left-section__four__hover')
    $('.introduce__map-land__left-section__five').addClass('introduce__map-land__left-section__five__hover')

    $('.introduce__map-land__right-section__four').addClass('introduce__map-land__right-section__four__hover')
    $('.introduce__map-land__right-section__three').addClass('introduce__map-land__right-section__three__hover')
    $('.introduce__map-land__right-section__five').addClass('introduce__map-land__right-section__five__hover')
    $('.introduce__map-land__right-section__one').addClass('introduce__map-land__right-section__one__hover')
    $('.introduce__map-land__right-section__two').addClass('introduce__map-land__right-section__two__hover')
  }, function () {
    // out
    $('.introduce__map-land__left-section__two').removeClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').removeClass('introduce__map-land__left-section__one__hover')
...
$('.introduce__map-land__left-section__two__click-section, .introduce__map-land__left-section__two__title').hover(function () {
    // over
...
$('.introduce__map-land__left-section__one__click-section, .introduce__map-land__left-section__one__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__four').addClass('introduce__map-land__left-section__four__hover')
...
$('.introduce__map-land__left-section__four__click-section, .introduce__map-land__left-section__four__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
...
$('.introduce__map-land__left-section__five__click-section, .introduce__map-land__left-section__five__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
...
$('.introduce__map-land__right-section__four__click-section, .introduce__map-land__right-section__four__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
...
$('.introduce__map-land__right-section__three__click-section, .introduce__map-land__right-section__three__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
...
$('.introduce__map-land__right-section__two__click-section, .introduce__map-land__right-section__two__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
...
$('.introduce__map-land__right-section__five__click-section, .introduce__map-land__right-section__five__click-section-2, .introduce__map-land__right-section__five__click-section-3, .introduce__map-land__right-section__five__title').hover(function () {
    // over
    $('.introduce__map-land__left-section__three').addClass('introduce__map-land__left-section__three__hover')
    $('.introduce__map-land__left-section__two').addClass('introduce__map-land__left-section__two__hover')
    $('.introduce__map-land__left-section__one').addClass('introduce__map-land__left-section__one__hover')
...
function changeActive () {
  ...
  if (whoActive === 'L-4') {
    ...
    $('#left-link-4 .introduce__map-name-section__left-section__content__part__text').addClass('introduce__map-name-section__left-section__content__part__text___left-four-active')
  } else {
    ...
    $('#left-link-4 .introduce__map-name-section__left-section__content__part__text').removeClass('introduce__map-name-section__left-section__content__part__text___left-four-active')
  }
...
$('.introduce__board__btn-right').click(function (e) { 
  e.preventDefault()
  const sectionArray = ['R-1', 'R-2', 'R-3', 'R-4', 'R-5', 'L-1', 'L-2', 'L-3', 'L-4', 'L-5']
...
/* name section hover 效果 */
$('#left-link-1').hover(function () {
    // over
    $('#left-link-1 .introduce__map-name-section__left-section__content__part__number').addClass('introduce__map-name-section__left-section__content__part__number__active')
    $('#left-link-1 .introduce__map-name-section__left-section__content__part__text').addClass('introduce__map-name-section__left-section__content__part__text__active')
  }, function () {
