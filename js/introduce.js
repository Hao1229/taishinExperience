...
function guideChange () {
  switch (whoActive) {
    ...
    case 'R-5':
      ...
      $('.introduce__guide-line').css('width', '6.98vw')
      $('.introduce__guide-line').css('height', '4.88vh')
      $('.introduce__guide-line-section').css('width', '6.98vw')
      $('.introduce__guide-line-section').css('height', '4.88vh')
      $('.introduce__guide-line-section').css('right', '37.76vw')
      $('.introduce__guide-line-section').css('bottom', '46.3vh')
      setTimeout(() => {
        $('.introduce__guide-line-mask').addClass('introduce__guide-line-mask__active')
