...
function guideChange () {
  switch (whoActive) {
    ...
    case 'R-5':
      ...
      $('.introduce__guide-line').css('width', '10.98vw')
      $('.introduce__guide-line').css('height', '6.88vh')
      $('.introduce__guide-line-section').css('width', '10.98vw')
      $('.introduce__guide-line-section').css('height', '6.88vh')
      $('.introduce__guide-line-section').css('right', '37.76vw')
      $('.introduce__guide-line-section').css('bottom', '46.3vh')
      setTimeout(() => {
        $('.introduce__guide-line-mask').addClass('introduce__guide-line-mask__active')
